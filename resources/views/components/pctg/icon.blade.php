...
@php
    $icons = [
        ...
        'gpu' => '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M11 9h4a2 2 0 0 0 2-2V3"/><circle cx="9" cy="9" r="2"/><path d="M7 21v-4a2 2 0 0 1 2-2h4"/><circle cx="17" cy="17" r="2"/>',
        ...
        'headset' => '<path d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5Zm18 0h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-5Z"/><path d="M3 13a9 9 0 0 1 18 0"/>',
...
<svg
    ...
    aria-hidden="true"
    {{ $attributes->merge(['class' => $class ?? 'h-5 w-5']) }}
>{!! $icons[$name] ?? $icons['cpu'] !!}</svg>
